...
Aprendizado sensível a custos é uma abordagem a nível de algoritmo para lidar com desbalanceamento entre classes, que se baseia na introdução de pesos para diferentes níveis de erro durante a fase de treinamento~\cite{FernndezCs2018}